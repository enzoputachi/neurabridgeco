...
type UserRole = 'investor' | 'expert' | null;
...
interface AuthContextType {
  ...
  userRole: UserRole;
  loading: boolean;
  signUp: (email: string, password: string, fullName: string, role: 'investor' | 'expert') => Promise<{ error: Error | null }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (email: string, password: string, fullName: string, role: 'investor' | 'expert') => {
